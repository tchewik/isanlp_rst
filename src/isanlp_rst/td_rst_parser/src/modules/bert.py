...
#     """
#
#     def __init__(self, model, n_layers, n_out, stride=50, pad_index=0, dropout=0, requires_grad=False):
#         super().__init__()
#
...
#         subwords = pad_sequence(subwords[mask].split(lens.tolist()), True, padding_value=self.pad_index)
